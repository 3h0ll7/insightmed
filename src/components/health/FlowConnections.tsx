...
const FlowConnections = ({ nodeCount }: FlowConnectionsProps) => {
  // We render SVG lines between node positions
  // Nodes are in a horizontal grid, each ~140px wide with gaps
    ...
    >
      <defs>
        <linearGradient id="lineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="hsl(185 80% 55% / 0.1)" />
          <stop offset="50%" stopColor="hsl(185 80% 55% / 0.6)" />
          <stop offset="100%" stopColor="hsl(185 80% 55% / 0.1)" />
        </linearGradient>
      </defs>
